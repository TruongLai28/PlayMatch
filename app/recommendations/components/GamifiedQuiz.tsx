...
export function GamifiedQuiz(props: GamifiedQuizProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Main Quiz Container */}
      <div className="relative max-w-[1600px] mx-auto overflow-visible rounded-xl border-2 border-sidebar-border shadow-lg shadow-[hsl(var(--sidebar-border))] bg-gradient-to-r from-transparent to-sidebar-accent/10 p-8">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-purple-300 font-medium">Step 1 of 4</span>
              </div>
            ...
            <div className="relative max-w-2xl mx-auto search-container">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-3 text-lg bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-400 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
              />
              ...
              {props.showSuggestions && props.searchSuggestions.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-zinc-800 border border-zinc-700 rounded-xl shadow-lg z-50 max-h-96 overflow-y-auto">
                  <div className="p-2 space-y-2">
                    {props.searchSuggestions.map((game: any, index: number) => (
                      ...
                      >
                        <div className="flex-shrink-0 w-16 h-24 bg-zinc-700 rounded-lg overflow-hidden shadow-md">
                          {game.cover?.url ? (
                            <img
                              src={game.cover.url}
                              alt={game.name}
                        ...
                        <div className="flex-grow min-w-0">
                          <div className="font-semibold text-white text-lg truncate">{game.name}</div>
                          <div className="flex items-center gap-2 mt-1">
                            {game.rating && (
                              <span className="text-purple-400 text-sm font-medium bg-purple-500/20 px-2 py-0.5 rounded">
            ...
            {props.selectedGames.length > 0 && (
              <div className="mt-8">
                <p className="text-zinc-400 text-center mb-4">Your Selected Games ({props.selectedGames.length}/{props.maxGames})</p>
                <div className="flex flex-wrap gap-4 justify-center">
                  {props.selectedGames.map((game: any) => (
                    ...
                    >
                      <div className="w-24 h-32 bg-zinc-800 rounded-lg overflow-hidden border-2 border-purple-500/50 hover:border-purple-500 transition-all shadow-lg hover:scale-105">
                        {game.cover?.url ? (
                          <img
                            src={game.cover.url}
                            alt={game.name}
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 w-6 h-6 bg-red-500 hover:bg-red-600 text-white rounded-full text-sm flex items-center justify-center shadow-lg transition-all hover:scale-110"
                      >
                        ×
                      </button>
                      <p className="text-xs text-zinc-400 text-center mt-2 max-w-[96px] truncate">{game.name}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex justify-center mt-8">
              <Button
                ...
                className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-3 rounded-xl font-semibold disabled:opacity-50"
              >
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-fade-in">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full mb-4">
                <Target className="h-5 w-5 text-purple-400" />
                <span className="text-purple-300 font-medium">Step 2 of 4</span>
              </div>
              <h2 className="text-3xl font-bold text-white mb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {props.genres.filter(g => genreVisuals[g]).map((genre) => {
                ...
                return (
                  ...
                  >
                    <div className="text-5xl mb-3 filter drop-shadow-lg">{visual.emoji}</div>
                    <div className="font-semibold text-white mb-1 text-sm">{genre}</div>
            ...
            <div className="flex justify-center gap-4 mt-8">
              <Button
                ...
                variant="outline"
                className="border-zinc-600 text-zinc-300 hover:bg-zinc-800 px-6 py-3 rounded-xl"
              >
                Back
              </Button>
              <Button
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-purple-300 font-medium">Step 3 of 4</span>
              </div>
              <h2 className="text-3xl font-bold text-white mb-3">
            ...
            {/* Keywords */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-white mb-4 text-center">Game Features</h3>
              ...
              <div className="text-center text-zinc-400 text-sm mt-3">
            ...
            {/* Themes */}
            <div>
              <h3 className="text-xl font-semibold text-white mb-4 text-center">Themes & Moods</h3>
              <div className="flex flex-wrap gap-3 justify-center max-w-4xl mx-auto">
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fade-in">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full mb-4">
                <Target className="h-5 w-5 text-purple-400" />
                <span className="text-purple-300 font-medium">Step 4 of 4</span>
              </div>
              <h2 className="text-3xl font-bold text-white mb-3">
                Where do you play?
              </h2>
            ...
            {/* Final CTA */}
            <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-2xl p-8 border border-purple-500/30 mt-8">
              <div className="text-center">
                <Sparkles className="h-12 w-12 text-purple-400 mx-auto mb-4 animate-pulse" />
                <h3 className="text-2xl font-bold text-white mb-2">Ready to discover your perfect games?</h3>
                <p className="text-zinc-300 mb-6">We've learned your preferences. Time to find your next favorite!</p>
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 text-white px-12 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105 disabled:opacity-50"
                  >
                    {props.loading ? (
